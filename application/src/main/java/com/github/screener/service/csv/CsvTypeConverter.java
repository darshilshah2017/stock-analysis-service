...
public class CsvTypeConverter {
     ...
     * Returns BigDecimal.ZERO for null/empty/dash values; throws for any other malformed value.
     *
     * @param value the CSV value
     * @return BigDecimal or BigDecimal.ZERO if null/empty/dash
     * @throws NumberFormatException if value is present but not a valid number
     */
     ...
     * Returns 0.0 for null/empty/dash values; throws for any other malformed value.
     *
     * @param value the CSV value
